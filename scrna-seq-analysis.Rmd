...
Also, download and install R and RStudio if you haven't already done so. Once you are in R, install [install Bioconductor](https://www.bioconductor.org/install/) and [devtools](https://www.r-project.org/nosvn/pandoc/devtools.html). You can also create a new R Script/R Markdown file and save it to the GitHub repository folder you downloaded. 
