...
If you want to follow along, go to the [GitHub repository for this project](), called . It will contain many files and data that are necessary. Make sure you download the whole thing. 
...
Once you have installed R and RStudio, go to the 

In R, install [install Bioconductor](https://www.bioconductor.org/install/) and [devtools](https://www.r-project.org/nosvn/pandoc/devtools.html).
